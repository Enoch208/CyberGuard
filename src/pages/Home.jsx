...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>CyberGuard - Interactive Cybersecurity Learning Platform</title>
        <meta name="description" content="Master cybersecurity through interactive learning, AI-powered guidance, and real-world scenarios. Join our community of security enthusiasts today." />
        <meta name="keywords" content="cybersecurity, online learning, security awareness, AI mentorship, interactive learning, digital security" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://cyberguard.com" />
        <meta property="og:title" content="CyberGuard - Interactive Cybersecurity Learning Platform" />
        <meta property="og:description" content="Master cybersecurity through interactive learning, AI-powered guidance, and real-world scenarios. Join our community of security enthusiasts today." />
        <meta property="og:image" content="https://i.postimg.cc/Ssj9xnrD/cybersecurity-awareness-in-a-demure-way-super-realistic-and-cool-1-4.jpg" />

        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://cyberguard.com" />
        <meta property="twitter:title" content="CyberGuard - Interactive Cybersecurity Learning Platform" />
        <meta property="twitter:description" content="Master cybersecurity through interactive learning, AI-powered guidance, and real-world scenarios. Join our community of security enthusiasts today." />
        <meta property="twitter:image" content="https://i.postimg.cc/Ssj9xnrD/cybersecurity-awareness-in-a-demure-way-super-realistic-and-cool-1-4.jpg" />

        {/* Additional SEO tags */}
        <link rel="canonical" href="https://cyberguard.com" />
        <meta name="robots" content="index, follow" />
        <meta name="author" content="CyberGuard" />
      </Helmet>
